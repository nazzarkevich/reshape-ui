...
var MarkersView = function MarkersView(props) {
  ...
  }, /*#__PURE__*/_react["default"].createElement(_style.Axis, {
    className: "main-axis",
    styles: componentStyles.mainAxis
  }, _markers.mainAxisIcons.map(function (marker) {
    return /*#__PURE__*/_react["default"].createElement(_style.Marker, {
      key: marker,
  ...
  })), !hideCrossAxis ? /*#__PURE__*/_react["default"].createElement(_style.Axis, {
