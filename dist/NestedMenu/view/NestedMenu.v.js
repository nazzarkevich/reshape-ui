...
var NestedMenuView = function NestedMenuView(props) {
  ...
  if (options.length) {
    ...
    if (query) listStyle = _objectSpread(_objectSpread({}, listStyle), searchListStyle);
    listElement = /*#__PURE__*/_react["default"].createElement(_List["default"], {
      style: listStyle,
      elementRef: listRef
  ...
  var menuElement = /*#__PURE__*/_react["default"].createElement(_style.Menu, {
    className: className,
    styles: menuStyle,
    ref: rootRef
  }, !disableSearch ? /*#__PURE__*/_react["default"].createElement(_Input["default"], {
    secondary: true,
    elementRef: inputRef,
  ...
  if (open && modal) {
    return /*#__PURE__*/_reactDom["default"].createPortal(menuElement, document.body);
  }
  if (open) {
    return menuElement;
  }
