...
function (_Component) {
  ...
  function DropdownSearch(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DropdownSearch).call(this, props));
      ...
      if (_this.listElement) {
        ...
        if (listItem) {
          ...
          if (listItemTop > listHeight) {
            listItem.scrollIntoView(_objectSpread({}, _dropdownSearch.scrollIntoViewOptions, {
              block: 'end'
            }));
          }
  ...
  _createClass(DropdownSearch, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_DropdownSearch["default"], dropdownProps);
    }
  }], [{
